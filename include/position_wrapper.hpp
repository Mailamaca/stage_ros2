...
public:
  PositionWrapper(
    const rclcpp::Node::SharedPtr & node, Stg::ModelPosition * model, const std::string & tf_prefix)
  : model_(model)
  {
  ...
  void set_speed(double vx, double vy, double avz) { model_->SetSpeed(vx, vy, avz); }
